...
class CanBalancePrompt extends Prompt {
  constructor() {
    ...
    this._info = {
      title: "Can Balance",
      description:
        "Given a non-empty array, return true if there is a place to split the array so that the sum of the numbers on one side equal the sum of the numbers on the other side.",
      examples:
