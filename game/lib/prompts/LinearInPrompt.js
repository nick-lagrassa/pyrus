...
class LinearInPrompt extends Prompt {
  constructor() {
    ...
    this._info = {
      title: "Linear In",
      description:
        'Given two sorted arrays of integers, outer and inner, return true if all the numbers in inner appear in outer. The best solution makes only a single "linear" pass of both arrays, taking advantage of the fact that they are sorted',
