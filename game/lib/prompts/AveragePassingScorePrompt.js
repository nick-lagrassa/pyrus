...
class AveragePassingScorePrompt extends Prompt {
  constructor() {
    ...
    this._info = {
      ...
      description:
        "Given a list of scores, return the average among the passing scores. A passing score is any score greater than or equal to 70. If the list is empty or does not include any passing scores return 0. Note: all numbers in Javascript are floats.",
      examples:
