...
export default class Prompt extends Component {
    render() {
        ...
        const shouldShowExampleTests = !isWaitingForTestResults && prompt._exampleTestResults.length > 0;
        ...
        return (
            <div className="pa3 mb2 br2 bg-pear-near-white">
                ...
                <div>
                    ...
                    { shouldShowExampleTests && prompt._exampleTestResults.filter(result => !result.passed).map((result, i) => {
